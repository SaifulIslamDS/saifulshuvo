    ...
    <>
      ...
      <main id="main-content" className="inner-page privacy-page">
        ...
        <section className="section-shell compact-top"><div className="container privacy-content">
          ...
          <article><h2>First-party telemetry</h2><p>Anonymous telemetry can include the visited path, a server-hashed session identifier, Core Web Vitals and bounded browser error details. It does not intentionally include contact-form content, email addresses or authenticated administrator data.</p></article>
          ...
          <article><h2>Retention and deletion</h2><p>Anonymous telemetry is retained for the period configured in the CMS and can be purged by the administrator. Contact messages can be archived, marked as spam and permanently deleted through the protected inbox.</p></article>
